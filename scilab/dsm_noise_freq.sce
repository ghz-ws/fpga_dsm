...
subplot(1,3,1)
plot(frq1,20*log10(abs(amp1)),"-o",frq2,20*log10(abs(amp2)),"-s",frq3,20*log10(abs(amp3)),"-^")
...
subplot(1,3,2)
plot('ln',frq1,20*log10(abs(amp1)),"-o",frq2,20*log10(abs(amp2)),"-s",frq3,20*log10(abs(amp3)),"-^")
title("Delta-sigma noise spectrum","fontsize",5)
legend("1st","2nd","3rd",1,"in_lower_right")
xgrid()
xlabel("Normalized Freq [Hz]","fontsize",5)
ylabel("Gain [dB]","fontsize",5)
...
subplot(1,3,3)
plot(frq1,abs(amp1)^2,"-o",frq2,abs(amp2^2),"-s",frq3,abs(amp3)^2,"-^")
legend("1st","2nd","3rd",1,"in_lower_right")
xgrid()
xlabel("Normalized Freq [Hz]","fontsize",5)
